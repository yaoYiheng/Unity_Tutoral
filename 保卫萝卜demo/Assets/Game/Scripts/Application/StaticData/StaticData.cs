...
public class StaticData : Singleton<StaticData> 
{
    ...
    void InitWeapons()
    {
        ...
        m_Weapons.Add(1, new WeaponInfo(){WeaponID = 1, PrefabName = "Fan",    BasePrice = 1, NormalIcon = "Fan/Fan01",       DisableIcon = "Fan/Fan00",       MaxLevel = 3, AttactArea = 3.0f, FireRate = 1, BulletID = 1});
    }
    void InitLuoBo()
    {
        ...
        void InitMosterInfo()
    {
        ...
        m_Monsters.Add(1, new MonsterInfo(){MonsterID = 1, HealthPoint = 1, MoveSpeed = MONSTER_SPEED_ONE});
        m_Monsters.Add(2, new MonsterInfo(){MonsterID = 2, HealthPoint = 2, MoveSpeed = MONSTER_SPEED_ONE});
        m_Monsters.Add(3, new MonsterInfo(){MonsterID = 3, HealthPoint = 2, MoveSpeed = MONSTER_SPEED_ONE});
        m_Monsters.Add(4, new MonsterInfo(){MonsterID = 4, HealthPoint = 3, MoveSpeed = MONSTER_SPEED_ONE});
        m_Monsters.Add(5, new MonsterInfo(){MonsterID = 5, HealthPoint = 5, MoveSpeed = MONSTER_SPEED_ONE});
    }
